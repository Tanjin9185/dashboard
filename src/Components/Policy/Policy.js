...
import ActiveAdmission from "../ActiveAdmission/ActiveAdmission";
    ...
    return (
        <section className="flex flex-wrap bg-white rounded-lg grid grid-cols-6 ">
            <div className="col-span-4 rounded-lg md:col-span-6 lg:col-span-4">
                <div>
                    <h3 className="text-bold text-left text-2xl">Policies</h3>
                </div>
                ...
                <div className="flex">
                    <div className="w-full">
                        <h4 className="text-left text-xl"> Policy Usage </h4>
                        <Line
                            data={{
                                labels: [
                                    "Jan",
